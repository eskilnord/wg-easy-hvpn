...
const messages = { // eslint-disable-line no-unused-vars
  ...
  ua: {
    ...
    mode: 'Режим',
    hostMode: 'Режим хоста',
    clientMode: 'Режим клієнта',
  },
  ru: {
    name: 'Имя',
    password: 'Пароль',
  ...
  th: {
    ...
    donate: 'บริจาค',
    mode: 'รูปแบบ',
    hostMode: 'รูปแบบโฮสต์',
    clientMode: 'รูปแบบลูกค้า',
  },
  hi: { // github.com/rahilarious
    ...
    noPrivKey: 'ये उपयोगकर्ता की कोई भी गुप्त ���ाबी नहीं हे। बना नहीं सकते।',
